...
function alquilar(isbn) {
    ...
    if (libro.ejemplares > 0) {
        ...
        Swal.fire({
            icon: 'success',
            title: 'Libro alquilado',
            text: 'Has alquilado el libro exitosamente.'
        });
        libro.ejemplares--;
        mostrarListaLibros();
    } else {
        Swal.fire({
            ...
            text: 'El libro ya ha sido alquilado por otro usuario.'
        });
    }
}
...
function devolver(isbn) {
    ...
    if (libroIndex !== -1) {
        ...
        Swal.fire({
            ...
            text: `Has devuelto el libro: ${libroDevuelto.titulo}`
        });
    } else {
        Swal.fire({
            icon: 'error',
            title: 'Error al devolver',
            text: `No tienes el libro con ISBN ${isbn} en tu propiedad.`
        });
    }
}
